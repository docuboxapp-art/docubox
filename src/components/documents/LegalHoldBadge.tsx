...
export function LegalHoldBadge({ className = '' }: LegalHoldBadgeProps) {
  return (
    <span
      className={`inline-flex shrink-0 items-center gap-1 rounded-md border border-amber-200 bg-amber-50 px-1.5 py-0.5 text-[10px] font-600 text-amber-800 ${className}`}
