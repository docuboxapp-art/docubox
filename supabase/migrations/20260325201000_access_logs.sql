-- ============================================================
-- Tabla de registro de accesos de seguridad (access_logs)
-- Almacena cada inicio de sesión con datos de IP, geolocalización,
...
-- Política: inserción permitida para service_role (desde API route)
